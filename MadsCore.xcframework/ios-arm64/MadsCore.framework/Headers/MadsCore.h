...
- (instancetype)initWithPadId:(NSString *)padId debugCreative:(BOOL)debugCreative otherParams:(NSDictionary<NSString *, NSString *> *)otherParams __attribute__((swift_name("init(padId:debugCreative:otherParams:)"))) __attribute__((objc_designated_initializer));
@property (readonly) BOOL debugCreative __attribute__((swift_name("debugCreative")));
@property (readonly) NSDictionary<NSString *, NSString *> *otherParams __attribute__((swift_name("otherParams")));
@property (readonly) NSString *padId __attribute__((swift_name("padId")));
@end
...
- (instancetype)initWithId:(int64_t)id padId:(NSString *)padId advUid:(NSString * _Nullable)advUid hasMarkingLabel:(BOOL)hasMarkingLabel hasTelemetryEnabled:(BOOL)hasTelemetryEnabled hasAdFacadeStatsEnabled:(BOOL)hasAdFacadeStatsEnabled items:(NSArray<id<MadsCoreInAppAdItem>> *)items statistics:(NSArray<MadsCoreInAppAdStatistic *> * _Nullable)statistics __attribute__((swift_name("init(id:padId:advUid:hasMarkingLabel:hasTelemetryEnabled:hasAdFacadeStatsEnabled:items:statistics:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getModalsPadId:(NSString *)padId debugCreative:(BOOL)debugCreative otherParams:(NSDictionary<NSString *, NSString *> *)otherParams completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getModals(padId:debugCreative:otherParams:completionHandler:)")));
